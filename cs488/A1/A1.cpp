...
// Draw cube
// Using 2 triangles to form a square with 6 faces ie total of 12 triangles
// Using 8 vertices since a cube has 8 vertices

// size is ideally 36 vertices
void A1::renderCube( GLfloat * data_set, int size, float * color ){
    GLuint tmp_vao;
    GLuint tmp_vbo;
